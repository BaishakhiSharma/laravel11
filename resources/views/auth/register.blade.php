                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="wsus__login_form_input">
                                            ...
                                            <input type="password" placeholder="Your confirm password" name="password_confirmation">
                            ...
                            <form action="{{ route('register',['type' => 'instructor']) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="wsus__login_form_input">
                                            <label>Confirm Password</label>
                                            <input type="password" placeholder="Your confirm password" name="password_confirmation" required>
                                            <x-input-error :messages="$errors->get('password_confirmation')" class="mt-2" />
                                        </div>
                                    </div>
                                    <div class="col-xl-12">
